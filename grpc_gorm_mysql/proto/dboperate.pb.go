...
var file_dboperate_proto_rawDesc = []byte{
	...
	0x82, 0x02, 0x0a, 0x09, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x31, 0x0a,
	...
	0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x2e, 0x0a, 0x06, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74,
	0x12, 0x14, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x73, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x72,
...
var file_dboperate_proto_depIdxs = []int32{
	...
	1, // 3: proto.Operation.Select:input_type -> proto.selectRequest
	2, // 4: proto.Operation.execSql:input_type -> proto.sqlRequest
	3, // 5: proto.Operation.insert:output_type -> proto.reply
	3, // 6: proto.Operation.delete:output_type -> proto.reply
	3, // 7: proto.Operation.update:output_type -> proto.reply
	3, // 8: proto.Operation.Select:output_type -> proto.reply
	3, // 9: proto.Operation.execSql:output_type -> proto.reply
...
func (*UnimplementedOperationServer) Select(context.Context, *SelectRequest) (*Reply, error) {
